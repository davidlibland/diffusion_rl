...
Results are printed in tables and saved to experiments/data_quality/data_quality_results.json.
"""
...
with open("experiments/data_quality/data_quality_results.json", "w") as f:
    json.dump(output, f, indent=2)
print(f"\nResults saved to experiments/data_quality/data_quality_results.json")
