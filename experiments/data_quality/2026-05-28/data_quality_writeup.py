...
Results are loaded from experiments/data_quality/data_quality_results.json (written by
data_quality.py).
...
# Load results
# ---------------------------------------------------------------------------
with open("experiments/data_quality/data_quality_results.json") as f:
    results = json.load(f)
...
plt.tight_layout()
plt.savefig("experiments/data_quality/data_quality_variance_by_t.png", dpi=150, bbox_inches="tight")
plt.show()
print("Saved: experiments/data_quality/data_quality_variance_by_t.png")
...
ax.set_xticklabels([f"{m:.1f}" for m in BIN_MIDS])
plt.tight_layout()
plt.savefig("experiments/data_quality/data_quality_bias_by_t.png", dpi=150, bbox_inches="tight")
plt.show()
print("Saved: experiments/data_quality/data_quality_bias_by_t.png")
...
plt.tight_layout()
plt.savefig("experiments/data_quality/data_quality_avg_variance.png", dpi=150, bbox_inches="tight")
plt.show()
print("Saved: experiments/data_quality/data_quality_avg_variance.png")
...
plt.tight_layout()
plt.savefig("experiments/data_quality/data_quality_bootstrap.png", dpi=150, bbox_inches="tight")
plt.show()
print("Saved: experiments/data_quality/data_quality_bootstrap.png")
