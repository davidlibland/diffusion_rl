...
ref = json.loads(open("experiments/common/analytical_target.json").read())["V_0_0"]
...
fig.tight_layout()
fig.savefig("experiments/common/analytical_value_heatmaps.png", dpi=150)
...
fig2.tight_layout()
fig2.savefig("experiments/common/analytical_vs_network.png", dpi=150)
