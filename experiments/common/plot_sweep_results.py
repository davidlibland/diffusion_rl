...
# Analytical target
# ---------------------------------------------------------------------------
_target = json.loads(open("experiments/common/analytical_target.json").read())
...
fig1.tight_layout()
fig1.savefig("experiments/common/plot_sampling_methods.png", dpi=150)
...
fig2.tight_layout()
fig2.savefig("experiments/common/plot_loss_type.png", dpi=150)
...
fig3.tight_layout()
fig3.savefig("experiments/common/plot_off_vs_on.png", dpi=150)
...
fig4.tight_layout()
fig4.savefig("experiments/common/plot_lambda_sweep.png", dpi=150)
