...
plt.tight_layout()
plt.savefig("experiments/misc/2026-03-25_lambda_logz_sweep/logz_decomposition.png", dpi=150, bbox_inches="tight")
print(f"\nSaved: experiments/misc/2026-03-25_lambda_logz_sweep/logz_decomposition.png")
plt.close()
...
plt.tight_layout()
plt.savefig("experiments/misc/2026-03-25_lambda_logz_sweep/lambda_sweep_mctd_reward.png", dpi=150, bbox_inches="tight")
print(f"\nSaved: experiments/misc/2026-03-25_lambda_logz_sweep/lambda_sweep_mctd_reward.png")
plt.close()
