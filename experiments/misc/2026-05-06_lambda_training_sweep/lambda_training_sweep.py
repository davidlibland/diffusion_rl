...
plt.tight_layout()
plt.savefig("experiments/misc/2026-05-06_lambda_training_sweep/lambda_training_reward.png", dpi=150, bbox_inches="tight")
print(f"\nSaved: experiments/misc/2026-05-06_lambda_training_sweep/lambda_training_reward.png")
plt.close()
...
plt.tight_layout()
plt.savefig("experiments/misc/2026-05-06_lambda_training_sweep/lambda_training_mae.png", dpi=150, bbox_inches="tight")
print("Saved: experiments/misc/2026-05-06_lambda_training_sweep/lambda_training_mae.png")
plt.close()
...
plt.tight_layout()
plt.savefig("experiments/misc/2026-05-06_lambda_training_sweep/lambda_training_summary.png", dpi=150, bbox_inches="tight")
print("Saved: experiments/misc/2026-05-06_lambda_training_sweep/lambda_training_summary.png")
plt.close()
...
with open("experiments/misc/2026-05-06_lambda_training_sweep/lambda_training_results.json", "w") as f:
    json.dump(out, f, indent=2)
print("Saved: experiments/misc/2026-05-06_lambda_training_sweep/lambda_training_results.json")
