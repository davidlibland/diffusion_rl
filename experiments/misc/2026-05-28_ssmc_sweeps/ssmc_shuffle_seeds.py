...
`experiments/misc/2026-05-28_offpolicy_seeds/offpolicy_seeds_results.json` and produces a side-by-side plot
...
plt.tight_layout()
out = "experiments/misc/2026-05-28_ssmc_sweeps/ssmc_shuffle_seeds.png"
plt.savefig(out, dpi=140, bbox_inches="tight")
print(f"\nSaved: {out}")

with open("experiments/misc/2026-05-28_ssmc_sweeps/ssmc_shuffle_seeds_results.json", "w") as f:
    json.dump(
        {
