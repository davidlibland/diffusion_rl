...
plt.tight_layout()
out = "experiments/misc/2026-05-28_ssmc_sweeps/ssmc_one_per_traj.png"
plt.savefig(out, dpi=150, bbox_inches="tight")
print(f"\nSaved: {out}")

with open("experiments/misc/2026-05-28_ssmc_sweeps/ssmc_one_per_traj_results.json", "w") as f:
    json.dump(
        {
            "config": {
