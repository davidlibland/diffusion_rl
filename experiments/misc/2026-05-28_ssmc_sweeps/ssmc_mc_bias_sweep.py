...
plt.tight_layout()
out = "experiments/misc/2026-05-28_ssmc_sweeps/ssmc_mc_bias_sweep.png"
...
plt.tight_layout()
out_t = "experiments/misc/2026-05-28_ssmc_sweeps/ssmc_mc_bias_vs_t.png"
plt.savefig(out_t, dpi=140, bbox_inches="tight")
print(f"Saved: {out_t}")

with open("experiments/misc/2026-05-28_ssmc_sweeps/ssmc_mc_bias_sweep_results.json", "w") as f:
    json.dump({
        "config": {
