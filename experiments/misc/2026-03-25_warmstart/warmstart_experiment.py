...
plt.tight_layout()
plt.savefig("experiments/misc/2026-03-25_warmstart/warmstart_reward.png", dpi=150, bbox_inches="tight")
print(f"\nSaved: experiments/misc/2026-03-25_warmstart/warmstart_reward.png")
plt.close()
...
plt.tight_layout()
plt.savefig("experiments/misc/2026-03-25_warmstart/warmstart_bias.png", dpi=150, bbox_inches="tight")
print("Saved: experiments/misc/2026-03-25_warmstart/warmstart_bias.png")
plt.close()
