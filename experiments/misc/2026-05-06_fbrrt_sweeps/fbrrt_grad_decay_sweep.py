...
plt.tight_layout()
plt.savefig("experiments/misc/2026-05-06_fbrrt_sweeps/fbrrt_gd_sweep.png", dpi=150, bbox_inches="tight")
print(f"\nSaved: experiments/misc/2026-05-06_fbrrt_sweeps/fbrrt_gd_sweep.png")
plt.close()
print("\nDone.")
