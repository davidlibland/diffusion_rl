...
plt.tight_layout()
plt.savefig("experiments/misc/2026-05-06_fbrrt_sweeps/fbrrt_alpha_sweep.png", dpi=150, bbox_inches="tight")
print("\nSaved: experiments/misc/2026-05-06_fbrrt_sweeps/fbrrt_alpha_sweep.png")

with open("experiments/misc/2026-05-06_fbrrt_sweeps/fbrrt_alpha_sweep_results.json", "w") as f:
