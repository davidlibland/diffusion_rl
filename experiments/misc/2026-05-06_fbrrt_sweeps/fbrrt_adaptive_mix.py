...
plt.tight_layout()
plt.savefig("experiments/misc/2026-05-06_fbrrt_sweeps/fbrrt_adaptive_mix.png", dpi=150, bbox_inches="tight")
print(f"\nSaved: experiments/misc/2026-05-06_fbrrt_sweeps/fbrrt_adaptive_mix.png")
plt.close()
print("Done.")
