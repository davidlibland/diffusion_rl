...
STUDY_DB = "sqlite:///experiments/bs4_moons/optuna_onpolicy.db"
...
def main():
    ...
    with open("experiments/bs4_moons/optuna_onpolicy_results.json", "w") as f:
        json.dump(summary, f, indent=2)
    print(f"\nSaved: experiments/bs4_moons/optuna_onpolicy_results.json")
