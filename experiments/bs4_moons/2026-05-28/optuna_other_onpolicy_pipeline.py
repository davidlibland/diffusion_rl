...
STUDY_DB = "sqlite:///experiments/bs4_moons/optuna_other.db"
...
json.dump([{"trial": t.number, "lcb": t.value, "params": trial_params(t)}
           for t in chosen],
          open("experiments/bs4_moons/optuna_other_top.json", "w"), indent=2)
...
json.dump(confirm, open("experiments/bs4_moons/optuna_other_confirm_results.json", "w"),
          indent=2)
...
prior = {}
for pth, lbl in [("experiments/bs4_moons/optuna_confirm_converge_results.json", "on"),
                 ("experiments/bs4_moons/optuna_offpolicy_pipeline_results.json", "off")]:
    if os.path.exists(pth):
...
plt.tight_layout()
plt.savefig("experiments/bs4_moons/optuna_other_onpolicy_pipeline.png", dpi=140,
            bbox_inches="tight")
print("\nSaved: experiments/bs4_moons/optuna_other_onpolicy_pipeline.png", flush=True)
...
json.dump(
    ...
    open("experiments/bs4_moons/optuna_other_onpolicy_pipeline_results.json", "w"),
    indent=2)
print("Saved: experiments/bs4_moons/optuna_other_onpolicy_pipeline_results.json")
