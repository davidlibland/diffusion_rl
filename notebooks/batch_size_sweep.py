...
plt.tight_layout()
plt.savefig("notebooks/batch_size_sweep.png", dpi=150, bbox_inches="tight")
print("\nSaved: notebooks/batch_size_sweep.png")

# ── Save JSON ─────────────────────────────────────────────────────────────
with open("notebooks/batch_size_sweep_results.json", "w") as f:
    json.dump({
        "configs": configs,
