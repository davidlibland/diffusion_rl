...
plt.tight_layout()
plt.savefig("notebooks/warmstart_final_reward.png", dpi=150, bbox_inches="tight")
print("\nSaved: notebooks/warmstart_final_reward.png")
plt.close()
...
plt.tight_layout()
plt.savefig("notebooks/warmstart_final_mae.png", dpi=150, bbox_inches="tight")
print("Saved: notebooks/warmstart_final_mae.png")
plt.close()
...
plt.tight_layout()
plt.savefig("notebooks/warmstart_final_bins.png", dpi=150, bbox_inches="tight")
print("Saved: notebooks/warmstart_final_bins.png")
plt.close()
