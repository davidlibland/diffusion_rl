...
compare against:
  - off-policy 10-seed distribution (notebooks/offpolicy_seeds_results.json)
  - SSMC k=0 shuffled WITH EMA (notebooks/ssmc_shuffle_seeds_results.json)
"""
...
PRIOR_SHUF_EMA_RESULTS = "notebooks/ssmc_shuffle_seeds_results.json"
...
plt.tight_layout()
out = "notebooks/ssmc_shuffle_no_ema_seeds.png"
plt.savefig(out, dpi=140, bbox_inches="tight")
print(f"\nSaved: {out}")

with open("notebooks/ssmc_shuffle_no_ema_seeds_results.json", "w") as f:
    json.dump(
        {
            "config": {
