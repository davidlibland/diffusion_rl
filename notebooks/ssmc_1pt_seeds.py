...
from `notebooks/offpolicy_seeds_results.json` and produces a side-by-side
distribution plot.
"""
...
PRIOR_SHUF_RESULTS = "notebooks/ssmc_shuffle_seeds_results.json"
...
plt.tight_layout()
out = "notebooks/ssmc_1pt_seeds.png"
plt.savefig(out, dpi=140, bbox_inches="tight")
print(f"\nSaved: {out}")

with open("notebooks/ssmc_1pt_seeds_results.json", "w") as f:
    json.dump(
        {
            "config": {
