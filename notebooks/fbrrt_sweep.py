...
plt.tight_layout()
plt.savefig("notebooks/fbrrt_sweep_reward.png", dpi=150, bbox_inches="tight")
print("\nSaved: notebooks/fbrrt_sweep_reward.png")
plt.close()
...
ax.set_yscale("log")
plt.tight_layout()
plt.savefig("notebooks/fbrrt_sweep_mae.png", dpi=150, bbox_inches="tight")
print("Saved: notebooks/fbrrt_sweep_mae.png")
plt.close()
...
plt.tight_layout()
plt.savefig("notebooks/fbrrt_sweep_summary.png", dpi=150, bbox_inches="tight")
print("Saved: notebooks/fbrrt_sweep_summary.png")
plt.close()
...
with open("notebooks/fbrrt_sweep_results.json", "w") as f:
    json.dump(out, f, indent=2)
print("Saved: notebooks/fbrrt_sweep_results.json")
