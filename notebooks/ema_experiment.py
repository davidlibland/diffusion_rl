...
plt.tight_layout()
plt.savefig("notebooks/ema_experiment_reward.png", dpi=150, bbox_inches="tight")
print(f"\nSaved: notebooks/ema_experiment_reward.png")
plt.close()
...
plt.tight_layout()
plt.savefig("notebooks/ema_experiment_mae.png", dpi=150, bbox_inches="tight")
print("Saved: notebooks/ema_experiment_mae.png")
plt.close()
