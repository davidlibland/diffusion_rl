...
with open("notebooks/data_quality_v2_results.json") as f:
    data = json.load(f)
...
for stage_key, stage_title in STAGES:
    ...
    plt.tight_layout()
    plt.savefig(f"notebooks/dq2_clean_{stage_key}.png", dpi=150, bbox_inches="tight")
    print(f"Saved: notebooks/dq2_clean_{stage_key}.png")
    plt.close()
