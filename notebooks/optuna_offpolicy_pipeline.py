...
notebooks/optuna_confirm_converge_results.json if present.
"""
...
STUDY_DB = "sqlite:///notebooks/optuna_offpolicy.db"
...
top3_cfg = [{"trial": t.number, "lcb": t.value, "params": dict(t.params)}
            for t in top3]
json.dump(top3_cfg, open("notebooks/optuna_offpolicy_top.json", "w"), indent=2)
...
print("=" * 70, flush=True)
json.dump(confirm, open("notebooks/optuna_off_confirm_results.json", "w"),
          indent=2)
...
on_path = "notebooks/optuna_confirm_converge_results.json"
...
on_full = "notebooks/optuna_confirm_converge_results.json"
...
plt.tight_layout()
plt.savefig("notebooks/optuna_offpolicy_pipeline.png", dpi=140,
            bbox_inches="tight")
print("\nSaved: notebooks/optuna_offpolicy_pipeline.png", flush=True)
...
json.dump(
    ...
    open("notebooks/optuna_offpolicy_pipeline_results.json", "w"), indent=2)
print("Saved: notebooks/optuna_offpolicy_pipeline_results.json")
