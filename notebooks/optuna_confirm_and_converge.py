...
Phase 1 — confirm:
  ...
  notebooks/optuna_top_configs.json) × 5 seeds × 5000 steps.
...
TOP_CFG = "notebooks/optuna_top_configs.json"
...
json.dump(
    ...
    open("notebooks/optuna_confirm_results.json", "w"), indent=2)
...
plt.tight_layout()
plt.savefig("notebooks/optuna_confirm_converge.png", dpi=140, bbox_inches="tight")
print("\nSaved: notebooks/optuna_confirm_converge.png", flush=True)
...
json.dump(
    ...
    open("notebooks/optuna_confirm_converge_results.json", "w"), indent=2)
print("Saved: notebooks/optuna_confirm_converge_results.json")
