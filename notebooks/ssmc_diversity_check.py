...
def main():
    ...
    plot_trajectories(
        ...
        "notebooks/ssmc_diversity_baseline.png",
    )
    ...
    plot_trajectories(
        ...
        "notebooks/ssmc_diversity_fixed.png",
    )
    ...
    plt.tight_layout()
    plt.savefig("notebooks/ssmc_diversity_k_sweep.png", dpi=150, bbox_inches="tight")
    print("  saved notebooks/ssmc_diversity_k_sweep.png")
