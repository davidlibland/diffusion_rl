...
PRIOR_MC10_NOEMA_RESULTS = "notebooks/ssmc_shuffle_no_ema_seeds_results.json"
...
plt.tight_layout()
out = "notebooks/ssmc_shuffle_mc1_seeds.png"
plt.savefig(out, dpi=140, bbox_inches="tight")
print(f"\nSaved: {out}")

with open("notebooks/ssmc_shuffle_mc1_seeds_results.json", "w") as f:
    json.dump(
        {
            "config": {
