...
demonstrably better than controlling one. It does not dominate the family:
above $d=2$, unclipped Itakura--Saito is the more accurate value estimator. The
durable contribution is therefore the reduction itself --- that loss design
here is the choice of a single positive weight, and that squared error is a
poor choice of it --- rather than a claim that our weight is the best available
one.
