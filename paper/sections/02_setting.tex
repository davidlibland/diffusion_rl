...
(\S\ref{sec:06_sparsity_onpolicy}). Propose instead under any adapted twist
...
incremental weight used in twisted-SMC samplers
\citep{singhal2025fksteering}. The twist $u$ is therefore \emph{free}: it
...
operator $\mathcal{T}_s$ acting on a candidate value function $W$ by
\begin{equation}
