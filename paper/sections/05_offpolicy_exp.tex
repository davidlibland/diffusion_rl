...
well on control while learning a badly biased value. Since the pathology of
\S\ref{sec:03_expmse} is about the \emph{magnitude} of the learned value in
under-predicted regions, the value axis is where we expect it to show, and a
control-only comparison could miss it entirely. \emph{Control quality} is the fraction of
